# Generated by Powerlevel10k configuration wizard on 2023-07-11 at 20:50 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 13747.
...
() {
  ...
  function prompt_packages() {
  	res="$(/usr/bin/upgrade-watcher module_merged)"
  	p10k segment -f 'grey' -t "$res"
  }
